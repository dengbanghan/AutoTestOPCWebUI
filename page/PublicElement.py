...
class PublicElement(WebDriver):
    ...
    error_msg = "用例执行失败：{}"
    # 输入框的元素
    input_box = (By.CLASS_NAME,'md-input-item-input')
    # 下拉框的元素
    select_box = (By.CLASS_NAME,'md-field-item-control')
    # 输入框标题
    input_title = (By.CLASS_NAME,'label')
    # 标题文案
    title_text = (By.CLASS_NAME, 'title')
    # toast弹窗文案
    toast_text = (By.CLASS_NAME,'md-toast-text')
    # 登录、提交申请等按钮
    button = (By.CLASS_NAME,'md-button')
    # 页面提示文案
